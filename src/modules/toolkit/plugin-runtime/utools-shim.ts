...
(function() {
  ...
  window.utools = {
    ...
    simulateMouseDoubleClick: (x, y) => callHost('simulateMouseDoubleClick', [x, y]),
    simulateMouseRightClick: (x, y) => callHost('simulateMouseRightClick', [x, y]),
    screenColorPick: (cb) => callHost('screenColorPick').then(r => cb && cb(r)),
    getPrimaryDisplay: () => callHost('getPrimaryDisplay'),
    getAllDisplays: () => callHost('getAllDisplays'),
    getCursorScreenPoint: () => callHost('getCursorScreenPoint'),
    getDisplayNearestPoint: (point) => callHost('getDisplayNearestPoint', [point]),
    getDisplayMatching: (rect) => callHost('getDisplayMatching', [rect]),
    screenToDipPoint: (point) => callHost('screenToDipPoint', [point]),
    dipToScreenPoint: (point) => callHost('dipToScreenPoint', [point]),
    screenToDipRect: (rect) => callHost('screenToDipRect', [rect]),
    dipToScreenRect: (rect) => callHost('dipToScreenRect', [rect]),
    desktopCaptureSources: (opts) => callHost('desktopCaptureSources', [opts]),
