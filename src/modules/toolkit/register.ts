...
export function registerAllTools() {
  ...
  registerTool({ id: "timestamp", name: "时间戳", icon: "🕐", category: "text", component: TimestampTool });
  registerTool({ id: "base64", name: "Base64", icon: "B6", category: "encoding", component: Base64Tool });
  ...
  registerTool({ id: "ip-info", name: "IP 信息", icon: "🌐", category: "network", component: IpInfoTool });
  registerTool({ id: "hosts", name: "Hosts 编辑", icon: "📝", category: "network", component: HostsEditorTool });
}